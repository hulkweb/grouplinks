...
<body class="">
                                ...
                                <tbody>
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td><a href="countries.php?del=<?= $group['id'] ?>"><div class="btn btn-danger">Delete</div> </a></td>  
    ...
    if (isset($_POST['create'])) {
        ...
        $insert = mysqli_query($con, "INSERT INTO countries (name,slug) VALUES ('$name','$slug')");
        if ($insert) {
            echo "<script> alert('inserted'); location.replace('countries.php')</script>";
        }else{
            echo "<script> alert('lge'); location.replace('countries.php')</script>";
    ...
    if (isset($_GET['del'])) {
        $id = $_GET['del'];
        $d = mysqli_query($con, "DELETE FROM countries  WHERE id='$id' ");
        if ($d) {
            echo "<script> alert('Deleted'); location.replace('countries.php')</script>";
        }
    }
