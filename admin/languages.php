...
<body class="">
                                ...
                                <tbody>
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td><?= $group['name'] ?></td>
                                            <td><a href="languages.php?del=<?= $group['id'] ?>"><div class="btn btn-danger">Delete</div> </a></td>  
    ...
    if (isset($_POST['create'])) {
        ...
        $insert = mysqli_query($con, "INSERT INTO languages (name,slug) VALUES ('$name','$slug')");
        if ($insert) {
            echo "<script> alert('inserted'); location.replace('languages.php')</script>";
        }else{
            echo "<script> alert('lge'); location.replace('languages.php')</script>";
    ...
    if (isset($_GET['del'])) {
        $id = $_GET['del'];
        $d = mysqli_query($con, "DELETE FROM languages  WHERE id='$id' ");
        if ($d) {
            echo "<script> alert('Deleted'); location.replace('languages.php')</script>";
        }
    }
