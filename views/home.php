...
<div class="content">
    <div class="wrap">
        <div id="main" role="main">
            ...
            <?php $groups = get_groups_all($pdo);
            foreach ($groups as $group) { ?>

                <div class="maindiv">
                    <div> <a style="color: #5a5a5a" target="_blank" href="../invite/<?= $group['link'] ?>" title="Whatsapp group invite link: <?= $group['name'] ?>"><span><img src="../pps.whatsapp.net/v/t61.24694-24/328704993_216192720809513_7739274909789861998_ndd44.jpg?ccb=11-4&amp;oh=01_AdQWgC-MpJyi3EdVeJivyjPGYsQV0k9_vzl6JISF_-SROw&amp;oe=6407196F" class="image" onerror="imgError(this);" alt="<?= $group['name'] ?>"></span></a>
                        <a target="_blank" href="../invite/<?= $group['link'] ?>" title="Whatsapp group invite link: <?= $group['name'] ?>"><span class="gtitle"><?= $group['name'] ?></span></a>
                    </div>
                    <div class="post-info">
                        <div class="post-basic-info">
                            <span>
                                <img src="./assets/images/category.png" class="icon">
                                <a href="./category/<?= $group['category']['slug'] ?>" title="<?= $group['category']['name'] ?>WhatsaApp groups invite link"><?= $group['category']['name'] ?></a>
                            </span>
                            <span>
                                <img src="./assets/images/country.png" class="icon">
                                <a href="./country/<?= $group['country']['slug'] ?>" title="<?= $group['country']['name'] ?> Whatsapp group link"> <?= $group['country']['name'] ?> </a></span>
                            <span>
                                <img src="./assets/images/language.png" class="icon">
                                <a href="./language/<?= $group['language']['slug'] ?>" title="<?= $group['language']['name'] ?> Whatsapp group join links"><?= $group['language']['name'] ?> </a></span>
                        ...
                        <div class="post-info-rate-share"> <span class="joinbtn"><a class="joinbtn" href="../join/<?= $group['link'] ?>" target="_blank" title="Click here to join <?= $group['name'] ?> Whatsapp group" rel="nofollow">Join
                                    group</a></span>
                            <div class="post-share">
                                <div>
                                    ...
                                    <a href="whatsapp://send?text=Follow this link to Join my Whatsapp group : <?= $url ?>group/invite/<?= $group['link'] ?>" data-action="share/whatsapp/share">
                                        <img src="./assets/images/whatsapp.png" width="24" height="24" alt="Share on Whatsapp" title="Share on Whatsapp" rel="nofollow" /></a>
                                    ...
                                    <a href="https://twitter.com/intent/tweet?text=Follow%20this%20link%20to%20Join%20my%20Whatsapp%20group%20:%20&amp;url=<?= $url ?>group/invite/<?= $group['link'] ?>" target="_blank" rel="nofollow">
                                        <img src="./assets/images/twitter.jpg" width="24" height="24" alt="Share on Twitter" title="Share on Twitter" /></a>
                                </div>
                            </div>
                        </div>
                    </div>
