...
<div class="content">
    <div class="wrap">
        <div id="main" role="main">
            ...
            <!-- <div id="report" style="display: none"><img src="<?= $url ?>assets/images/loader.gif" style="height: 40px;margin-top: 10px"></div> -->
            ...
            foreach ($groups as $group) { ?>
                ...
                <div class="maindiv">
                    <div> <a style="color: #5a5a5a" target="_blank" href="<?= $url ?>invite/<?= $group['link'] ?>" title="Whatsapp group invite link: <?= $group['name'] ?>"><span><img src=".<?= $url ?>pps.whatsapp.net/v/t61.24694-24/328704993_216192720809513_7739274909789861998_ndd44.jpg?ccb=11-4&amp;oh=01_AdQWgC-MpJyi3EdVeJivyjPGYsQV0k9_vzl6JISF_-SROw&amp;oe=6407196F" class="image" onerror="imgError(this);" alt="<?= $group['name'] ?>"></span></a>
                    ...
                    <div class="post-info">
                        <div class="post-basic-info">
                            <span>
                                ...
                                <a href="<?= $url ?>group/category/<?= $group['category']['slug'] ?>" title="<?= $group['category']['name'] ?>WhatsaApp groups invite link"><?= $group['category']['name'] ?></a>
                            </span>
                            <span>
...
<script src="<?= $url ?><?= $url ?>assets/js/jquery-1.10.2.min.js"></script>
